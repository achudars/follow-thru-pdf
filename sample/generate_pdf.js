...
// ── Layout ────────────────────────────────────────────────────────────────────
const ML   = 50, MR = 545.28, CW = MR - ML
const COL_ACTION = ML
...
const ALL_BANKING = [
  { action: 'Add',       name: 'Reginald Pompington III',  phone: '4320001001', email: 'reggie@pompington.co.uk',   title: 'Chief Pomposity Officer',  alt: '',           country: 'United Kingdom', pr: false, cb: false, cn: false },
  { action: 'Add',       name: 'Chad Thunderstone',        phone: '4320001002', email: 'chad@thunderstone.com',     title: 'VP of Crushing It',        alt: '4320001012', country: 'USA',            pr: true,  cb: false, cn: true  },
  { action: 'Edit',      name: 'Patricia McPatface',       phone: '4320001003', email: 'pat@mcpatface.org',         title: 'Chief Pattern Maker',      alt: '',           country: 'Ireland',        pr: false, cb: true,  cn: false },
  { action: 'No Change', name: 'Bob Loblaw Jr.',           phone: '4320001004', email: 'bob@loblawlaw.com',         title: 'Legal Eagle Esq.',         alt: '4320001014', country: 'USA',            pr: true,  cb: true,  cn: true  },
  { action: 'Edit',      name: 'Karen Overreaction',       phone: '4320001005', email: 'karen@overreaction.net',    title: 'Head of Complaints',       alt: '',           country: 'Canada',         pr: false, cb: false, cn: true  },
  { action: 'Add',       name: 'Ferdinand von Fancypants', phone: '4320001006', email: 'ferd@fancypants.eu',        title: 'Duke of Finance',          alt: '',           country: 'Germany',        pr: true,  cb: false, cn: false },
  { action: 'Add',       name: 'Maximilian Von Bureaucrat',phone: '4320001007', email: 'max@vonbureaucrat.gov',     title: 'Minister of Forms',        alt: '4320001017', country: 'Austria',        pr: false, cb: true,  cn: true  },
  { action: 'Add',       name: 'Archibald Tweedledum',     phone: '4320001008', email: 'arch@tweedledum.com',       title: 'Senior Twiddler',          alt: '',           country: 'Australia',      pr: true,  cb: false, cn: true  },
  { action: 'Add',       name: 'Gertrude Snarksworth',     phone: '4320001009', email: 'gertie@snarksworth.biz',    title: 'Director of Eyerolls',     alt: '',           country: 'USA',            pr: false, cb: false, cn: false },
  { action: 'Edit',      name: 'Cornelius Blunderbus',     phone: '4320001010', email: 'cornelius@blunderbus.com',  title: 'Head of Mishaps',          alt: '4320001020', country: 'United Kingdom', pr: true,  cb: true,  cn: false },
  { action: 'Add',       name: 'Ophelia Giddyup',          phone: '4320001011', email: 'ophelia@giddyup.horse',     title: 'Chief Excitement Officer', alt: '',           country: 'USA',            pr: false, cb: false, cn: true  },
  { action: 'No Change', name: 'Wellington Bootsworthy',   phone: '4320001012', email: 'boots@wellington.uk',       title: 'VP of Footwear',           alt: '',           country: 'United Kingdom', pr: true,  cb: false, cn: false },
  { action: 'Add',       name: 'Barnaby Fudgefactor',      phone: '4320001013', email: 'barnaby@fudgefactor.co',    title: 'Senior Fudge Expert',      alt: '4320001023', country: 'Australia',      pr: false, cb: true,  cn: true  },
  { action: 'Edit',      name: 'Constance Headshaker',     phone: '4320001014', email: 'constance@headshaker.org',  title: 'Head of Disapproval',      alt: '',           country: 'Canada',         pr: true,  cb: false, cn: false },
  { action: 'Add',       name: 'Sir Pompous McBluster',    phone: '4320001015', email: 'sir@pompousmcbluster.uk',   title: 'Lord of Bluster',          alt: '',           country: 'United Kingdom', pr: true,  cb: true,  cn: true  },
  { action: 'Add',       name: 'Penelope Crumplehorn',     phone: '4320001016', email: 'penny@crumplehorn.co',      title: 'VP of Fancy Things',       alt: '',           country: 'USA',            pr: false, cb: false, cn: false },
  { action: 'Add',       name: 'Theodore Ramshackle',      phone: '4320001017', email: 'theo@ramshackle.biz',       title: 'Chief Rambler',            alt: '4320001027', country: 'Ireland',        pr: true,  cb: false, cn: true  },
  { action: 'Edit',      name: 'Beatrice Snortington',     phone: '4320001018', email: 'bea@snortington.co.uk',     title: 'Head of Snorting',         alt: '',           country: 'United Kingdom', pr: false, cb: true,  cn: false },
  { action: 'Add',       name: 'Ignatius Bumblebottom',    phone: '4320001019', email: 'ign@bumblebottom.com',      title: 'VP of Bottom Lines',       alt: '4320001029', country: 'USA',            pr: true,  cb: true,  cn: true  },
  { action: 'Add',       name: 'Lavinia Overwrought',      phone: '4320001020', email: 'lavinia@overwrought.net',   title: 'Director of Drama',        alt: '',           country: 'France',         pr: false, cb: false, cn: true  },
]

const ALL_SIGNERS = [
  { action: 'Add', name: 'Barry Bigglesworth',       phone: '5550001001', email: 'barry@bigglesworth.org',      title: 'Chairman of Everything',   alt: '',           country: 'USA',            pr: true, cb: true, cn: true },
  { action: 'Add', name: 'Svetlana Von Hunksworth',  phone: '5550001002', email: 'svetlana@vonhunksworth.com',  title: 'SVP of All Things',        alt: '5550001012', country: 'Germany',        pr: true, cb: true, cn: true },
  { action: 'Add', name: 'Leopold De Overpriced',    phone: '5550001003', email: 'leo@deoverpriced.fr',         title: 'Lord of Premium Services', alt: '',           country: 'France',         pr: true, cb: true, cn: true },
  { action: 'Add', name: 'Contessa Moneybags',       phone: '5550001004', email: 'contessa@moneybags.it',       title: 'Countess of Cashflow',     alt: '5550001014', country: 'Italy',          pr: true, cb: true, cn: true },
  { action: 'Add', name: 'Humphrey Balderdash',      phone: '5550001005', email: 'humphrey@balderdash.uk',      title: 'President of Nonsense',    alt: '',           country: 'United Kingdom', pr: true, cb: true, cn: true },
]
...
function sectionBanner(doc, y, label, color = '#1a3c5e') {
  ...
  doc.fillColor('#FFFFFF').fontSize(10).font('Helvetica-Bold').text(label, ML + 4, y + 6)
  doc.fillColor('#FFFFFF').fontSize(7).font('Helvetica').text('AUTHORITIES', COL_PR - 2, y + 4, { width: 100 })
}
...
function generatePdf(scenario, outputPath) {
  ...
  doc.fillColor('#FFFFFF').fontSize(13).font('Helvetica-Bold').text(scenario.label, ML, 10, { width: 380 })
  doc.fillColor('#93c5fd').fontSize(7.5).font('Helvetica').text('New York and London Bank Offices', ML, 30, { lineBreak: false })
  doc.fillColor('#93c5fd').text(scenario.subtitle, ML + 195, 30, { width: 305, align: 'right', lineBreak: false })
  ...
  hLine(doc, 130)
  doc.fillColor('#1a3c5e').fontSize(10).font('Helvetica-Bold').text('BANKING CONTACT AUTHORITIES', ML, 138)
  doc.fillColor('#374151').fontSize(7.5).font('Helvetica')
  const bullets = [
  ...
  bullets.forEach((b, i) => doc.text(`\u2022  ${b}`, ML + 6, 158 + i * 18, { width: CW - 6 }))

  // ── BANKING CONTACT DETAILS ────────────────────────────────────────────────
  hLine(doc, 220)
  sectionBanner(doc, 226, 'BANKING CONTACT DETAILS')
  doc.fillColor('#374151').fontSize(7).font('Helvetica')
  doc.text('Complete all required* fields when adding or modifying a contact. For removal, provide Full Legal Name only. *Optional fields are marked.', ML, 252, { width: CW })
  ...
  if (scenario.banking.length === 0) {
    ...
    doc.text('No Banking Contacts submitted for this cycle.', ML, bankTableStartY + 8, { width: CW, align: 'center' })
    hLine(doc, bankTableStartY + 24)
    bankingPositions = []
    var bankEnd = { positions: [], y: bankTableStartY + 24, page: curPage }
  } else {
    const result = drawContacts(doc, scenario.banking, bankTableStartY, curPage)
  ...
  doc.fillColor('#374151').fontSize(7).font('Helvetica')
  doc.text('Authorized Signers and Delegate Authorized Signers do not need to be listed as Banking Contacts.', ML, signerBannerY + COL_HDR_H + 2, { width: CW })
  ...
  if (scenario.signers.length === 0) {
    ...
    doc.fillColor('#9ca3af').fontSize(8).font('Helvetica-BoldOblique')
    doc.text('No Signer Authorizations submitted for this cycle.', ML, signerTableStartY + 8, { width: CW, align: 'center' })
    hLine(doc, signerTableStartY + 24)
    signerPositions = []
    var signerEnd = { y: signerTableStartY + 24, page: curPage }
  } else {
    const result = drawContacts(doc, scenario.signers, signerTableStartY, curPage)
  ...
  doc.text(`Page 1 of ${1 + scenario.appendixPages + 1}  \u2022  Confidential \u2014 For authorized use only`, ML, signerEnd.y + 10, { width: CW, align: 'center' })
  ...
  for (let i = 0; i < scenario.appendixPages; i++) {
    ...
    doc.fillColor('#FFFFFF').fontSize(9).font('Helvetica-Bold').text(ap.title, ML, 10)
    hLine(doc, 34, '#999999')
    doc.fillColor('#374151').fontSize(7.5).font('Helvetica').text(ap.body, ML, 44, { width: CW, lineBreak: true })
    doc.fillColor('#9ca3af').fontSize(6.5)
    doc.text(`Page ${curPage} of ${1 + scenario.appendixPages + 1}  \u2022  Confidential`, ML, 790, { width: CW, align: 'center' })
  }
  ...
  scenario.banking.forEach((c, i) => {
    ...
    mr(`contact:${c.action}|${c.name}|${c.phone}|${c.email}|${c.title}|${c.alt}|${c.country}|${c.pr}|${c.cb}|${c.cn}|${pos.page}|${pos.y}|${pos.h}`)
  })
